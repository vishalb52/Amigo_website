  ...
  <header class="header">
    <div class="container header__container">
      <nav class="navbar navbar-expand-md">
        <div class="header__logo"><img class="header__img" src="./images/chart-3186077.png">
          <h1 class="header__title">AMIGO<span class="header__light"></span></h1>
        </div>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarTogglerDemo02"
          aria-controls="navbarTogglerDemo02" aria-expanded="false" aria-label="Toggle navigation">
          <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse header__menu" id="navbarTogglerDemo02">
          <ul class="navbar-nav ms-auto header__elenco">
            <li class="navbar-item header__el">
              <a class="nav-link header__link" href="#">Home</a>
            </li>
            <li class="navbar-item header__el">
              <a class="nav-link header__link" href="#">Pricing</a>
            </li>
            <!-- <li class="navbar-item header__el">
              <a class="nav-link header__link" href="#">Success Stories</a>
            </li> -->
            <li class="navbar-item header__el">
              <a class="nav-link header__link" href="#">Blog</a>
            </li>
            <li class="navbar-item header__el">
              <a class="nav-link header__link" href="./Sentiment Analysis/in/aboutus.html">Contact Us</a>
            </li>
            <!-- <li class="navbar-item header__el">
              <a class="nav-link header__link" href="#">Download</a>
            </li> -->
          </ul>
        </div>
      </nav>
        ...
        <div class="col-md-12">
          <div class="site">
            ...
            <div class="site__box-link">
              <a class="btn" href="./Sentiment Analysis/index.html">Your Dashboard</a>
              <a class="btn btn--revert btn--width" href="./Sentiment Analysis/aboutus.html">Contact</a>
            </div>
      ...
      <div class="row row--center row--margin">
        <div class="col-md-4 col-sm-4 price-box price-box--purple">
          <div class="price-box__wrap">
            ...
            <h2 class="price-box__discount">
              <Analysis class="price-box__dollar"><strong>Analysis type: Weekly</strong></span>
            </h2>
            <!-- <h2 class="price-box__discount">
            ...
            <ul class="price-box__list">
              ...
              <li class="price-box__list-el">Guidance Provided</li>
              <li class="price-box__list-el">Data Collected Weekly</li>
              <li class="price-box__list-el">Single Dashboard Provided</li>
            </ul>
            <!-- <div class="price-box__btn">
              <a class="btn btn--purple btn-lg">Start now</a>
            </div> -->
          </div>
        </div>
        <!-- second -->
        <div class="col-md-4 col-sm-4 price-box price-box--violet">
          <div class="price-box__wrap">
            ...
            <h2 class="price-box__discount">
              <span class="price-box__dollar"><strong>Analysis Type: Monthly</strong></span>
            </h2>
            <!-- <h2 class="price-box__discount">
            ...
            <ul class="price-box__list">
              <li class="price-box__list-el">Upto 10 License Provided</li>
              <li class="price-box__list-el">Guidance Provided</li>
              <li class="price-box__list-el">Data Collected 24/7</li>
              <li class="price-box__list-el">Premium Dashboard Provided</li>
            </ul>
            <!-- <div class="price-box__btn">
              <a class="btn btn--violet btn-lg">Start now</a>
            </div> -->
          </div>
        </div>
        ...
        <div class="col-md-4 col-sm-4 price-box price-box--blue">
          <div class="price-box__wrap">
            ...
            <h2 class="price-box__discount">
              <span class="price-box__dollar"><strong>Analysis Type: Quaterly</strong></span>
            </h2>
            <!-- <h2 class="price-box__discount">
            ...
            <ul class="price-box__list">
              <li class="price-box__list-el">Upto 5 License Provided</li>
              <li class="price-box__list-el">Guidance Provided</li>
              <li class="price-box__list-el">Data Collected Monthly</li>
              <li class="price-box__list-el">Multiple dashboards Provided</h6></li>
            </ul>
            <!-- <div class="price-box__btn">
              <a class="btn btn--blue btn-lg">Start now</a>
            </div> -->
          </div>
        </div>
    ...
    <div class="container">
     ...
     <-- Indicators --> 
      ...
      <!-- <div class="carousel-inner">
              <div class="carousel-item item active">
                <div class="item__content">
                  <img class="item__img" src="https://cdn.worldvectorlogo.com/logos/slack-1.svg" alt="Slack"><span
                    class="item__name">slack</span>
      ...
      <!-- Left and right controls -->
       ...
       <!-- <button class="carousel-control-prev left carousel-control" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="prev">
      ...
      <button class="right carousel-control carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next">
...
<br>
  ...
  <div class="sect sect--white sect--no-padding">
    <div class="container">
      <div class="row row--center">
        <div class="col-md-4 col-xs-6 col-sm-6 partner">
          <a href="#" class="partner__link">
            <img class="partner_img" src="https://www.lytics.com/wp-content/uploads/2021/01/Facebook-Logo.png">
          </a>
        </div>
        ...
        <div class="col-md-4 col-xs-6 col-sm-6 partner">
          <a href="#" class="partner__link">
            <img class="partner_img" src="./images/Telegram (2).png">
          </a>
        </div>
      ...
      <div class="row row--center">
        <div class="col-md-4 col-xs-6 col-sm-6 partner">
          <a href="#" class="partner__link">
            <img class="partner_img" src="./images/whatsapp-png-14-removebg-preview.png">
          </a>
        </div>
      ...
      <div class="row row--margin">
        <div class="col-md-6 article-pre__col">
          <a href="#" class="article-pre ">
            ...
            <h1 class="article-pre__title">Sentiment Analysis<span
        ...
        <div class="col-md-6 article-pre__col">
          <a href="#" class="article-pre ">
            ...
            <h1 class="article-pre__title">Cricket  Analysis<span
                class="article-pre__arrow--purple">→</span></h1>
          </a>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6 article-pre__col">
          <a href="#" class="article-pre ">
            ...
            <h1 class="article-pre__title">Social Media Analysis<span
              class="article-pre__arrow--purple"> →</span></h1>
        ...
        <div class="col-md-6 article-pre__col">
          <a href="#" class="article-pre ">
            ...
            <h1 class="article-pre__title">Business Analysis<span
                class="article-pre__arrow--purple"> →</span></h1>
          </a>
        </div>
      </div>
        ...
        <div class="col-md-4">
          <div class="contacts">
            <a href="#" class="contacts__link"><img src="https://image.ibb.co/kcVou6/path3000.png">
              <h1 class="contacts_title-ag">AMIGO<span class="contacts--light"></span></h1>
            </a>
            <p class="contacts__address">
              SRM University<br>
              Kattankulathur,Chenna<br>
              India
            </p>
            <p class="contacts__info">
              tel. <a href="#" class="contacts__info-link">+91 6202990204</a>
            </p>
            <p class="contacts__info">
              m. <a href="#" class="contacts__info-link">pb4949@srmist.edu.in</a>
            </p>
            <p class="contacts__info">
              m. <a href="#" class="contacts__info-link">gk5013@srmist.edu.in</a>
            </p>
            <p class="contacts__info">
              m. <a href="#" class="contacts__info-link">vk5291@srmist.edu.in</a>
            </p>
            <p class="contacts__info">
              m. <a href="#" class="contacts__info-link">mu7974@srmist.edu.in</a>
            </p>
            <p class="contacts__info">
              m. <a href="#" class="contacts__info-link">eh6589@srmist.edu.in</a>
            </p>
          </div>
        </div>
        <div class="col-md-6">
  ...
  <div class="sect sect--violet ">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1 class="career_sub">Good day!</h1>
          <a href="#" class="btn btn--white btn--width">About Us</a>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-2 col-xs-6">
          ...
          <h1 class="footer__title">AMIGO<span class="footer__light"></span></h1>
        </div>
